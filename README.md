...
```
@software{akash_dhruv_2023_10211777,
  author       = {Akash Dhruv and
                  Sheikh Md Shakeel Hassan},
  title        = {{Lab-Notebooks/Outflow-Forcing-BubbleML: zenodo 
                   archive}},
  month        = nov,
  year         = 2023,
  publisher    = {Zenodo},
  version      = {zenodo},
  doi          = {10.5281/zenodo.10211777},
  url          = {https://doi.org/10.5281/zenodo.10211777}
}
```
